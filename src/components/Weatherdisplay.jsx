    ...
    return(
        <div className='weatherdisplay'>
            <h1>{`What's the motherfucking weather in ${city}??`}</h1>
                <div className="info">
                    <div className="text">
                    <i class="fas fa-meteor"></i><p>{`Today, it's goddamn ${description}, or just look through the window!`}</p>
                    <i class="fas fa-meteor"></i><p>{`It's ${temp}°C outside. But alas, it feels like ${feels}°C.`}</p>
                    <i class="fas fa-meteor"></i><p>{`The pressure is ${pressure} kPa and the humidity is ${humidity}%`}</p>
                    <i class="fas fa-meteor"></i><p>{`The wind speed is ${wind}m/s and it's blowing in the angle of ${windDeg}°`}</p>
                    <i class="fas fa-meteor"></i><p>{`The sky coverage with clouds is ${clouds}%`}</p>
                    </div>
                    <div className="images">
                        <img src={url} alt="Weather icon"></img>

                        <svg viewBox="0 0 475 313" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g id="Frame">
                                <rect id="sky" width="475" height="257" fill="#ABE6FF"/>
                                <path id="arrow" d="M420 225L426.645 185.135L388.799 199.313L420 225ZM52 225C55.3621 225.973 55.3619 225.973 55.362 225.973C55.3623 225.972 55.3625 225.971 55.3631 225.969C55.3642 225.965 55.3661 225.959 55.3688 225.95C55.3742 225.931 55.3827 225.902 55.3943 225.863C55.4176 225.784 55.4535 225.663 55.502 225.502C55.5992 225.18 55.747 224.696 55.9465 224.062C56.3454 222.792 56.9509 220.919 57.7699 218.529C59.4081 213.749 61.8997 206.903 65.3016 198.682C72.1099 182.229 82.5423 160.318 97.0439 138.433C126.122 94.5504 171.041 51.5 235.354 51.5L235.354 44.5C167.532 44.5 120.774 89.9496 91.2087 134.567C76.3887 156.932 65.758 179.271 58.8335 196.006C55.3691 204.378 52.8268 211.361 51.1479 216.26C50.3083 218.71 49.6843 220.64 49.2685 221.963C49.0605 222.625 48.9047 223.135 48.7999 223.482C48.7475 223.656 48.7079 223.789 48.6809 223.88C48.6674 223.926 48.6571 223.961 48.65 223.986C48.6464 223.998 48.6436 224.008 48.6416 224.014C48.6406 224.018 48.6397 224.021 48.6392 224.023C48.6385 224.025 48.6379 224.027 52 225ZM235.354 51.5C283.022 51.5 320.179 75.1215 348.235 105.255C376.318 135.419 395.053 171.882 405.732 196.879L412.169 194.129C401.337 168.775 382.221 131.486 353.358 100.485C324.468 69.4551 285.582 44.5 235.354 44.5L235.354 51.5Z" fill="#6FB1FF"/>
                                <g id="sunrise">
                                    <path id="Star 1" d="M52 205L54.2336 250.126L82.5648 214.931L57.8476 252.751L101.455 240.931L59.228 257L101.455 273.069L57.8476 261.249L82.5648 299.069L54.2336 263.874L52 309L49.7664 263.874L21.4352 299.069L46.1524 261.249L2.54506 273.069L44.772 257L2.54506 240.931L46.1524 252.751L21.4352 214.931L49.7664 250.126L52 205Z" fill="#FFD951"/>
                        ...
                        <p>{`And the sun will fuck off at ${sunset}`}</p>
                    </div>
                </div>
            </div>
    )} catch(err) {
